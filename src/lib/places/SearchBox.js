...
import * as helper from "../utils/SearchBoxHelper";
...
export default _.flowRight(
  ...
  componentWillMount() {
    this._inputElement = helper.createInputElement(this.props);
    // https://developers.google.com/maps/documentation/javascript/3.exp/reference#SearchBox
  ...
  componentDidMount() {
    this._mountIndex = helper.mountInputElementToControlPositionOnMap(
      this._inputElement,
  ...
  componentDidUpdate(prevProps) {
    if (this.props.controlPosition !== prevProps.controlPosition) {
      helper.unmountInputElementFromControlPositionOnMap(
        this._mountIndex,
